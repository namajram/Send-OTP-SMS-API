...
import com.api.dto.OtpStatus;
import com.api.dto.PasswordResetRequestDto;
import com.api.dto.PasswordResetResponseDto;
	  ...
	  @Autowired
	    ...
	    public Mono<PasswordResetResponseDto> sendOTPForPasswordReset(PasswordResetRequestDto passwordResetRequestDto) {
	        ...
	        try {
	            ...
	            String otpMessage = "Dear Customer , Your OTP is ##" + otp + "##. Use this Passcode to complete you email.";
	    ...
	    public Mono<String> validateOTP(String userInputOtp, String userName) {
	        if (userInputOtp.equals(otpMap.get(userName))) {
	            ...
	            return Mono.just("Valid OTP please proceed with your email !");
	        } else {
